...
function getPromptsMtime() {
  const files = ['system-core.md', 'characters.md', 'character-lore.md', 'magic-lore.md', 'world-lore.md', 'progression-lore.md', 'timetable-lore.md', 'storyline-lore.md'];
  return Math.max(
    ...files.map((f) => {
      try {
