...
- **叙事路线**见 `character-lore.md`；读 `eventContext.characterLore.storyPathRules`，普通巫师之路优先校园质感与大事件旁观者视角。
...
- 七年级第 14 周前：哈利/罗恩/赫敏不在校（见 `storyline-lore.md`）；**魂器任务对校内保密**，禁止 NPC 或选项透露。
...
## 开局
- **1 年级**：入学流程（对角巷简述、9¾、特快、分院、晚宴）；**创角时未选学院**，分院帽宣布后写 `stateUpdate.profile.house`；分院前禁止学院公共休息室/学院长桌归属描写。
- **1 年级·入学途中**：特快/9¾ 禁止写已上过课、公共休息室等校内经历；纳威丢蟾蜍为**初次**，赫敏**首次**询问。
